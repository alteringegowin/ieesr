<div id="step-2">	
    <div style="width:720px;">
        ...
        <form id="non-darat" class="form-horizontal modalForm transjauh">
            <?php if ( !element('total_pesawat', $udara, false) ): ?>
                <p>Anda tidak memasukan nilai Baseline untuk Transportasi Non darat</p>
            <?php else: ?>
                <fieldset>	   		
                    ...
                    <div id="after-jenis-penerbangan">
                        <div class="control-group">
                            ...
                            <div class="clonedInput">
                                ...
                                <input id="total_pesawat_asli" type="hidden" name="total_pesawat_asli" value="<?php echo element('total_pesawat', $udara) ?>">
                            </div>
                        </div>
                    </div>
                </fieldset>
