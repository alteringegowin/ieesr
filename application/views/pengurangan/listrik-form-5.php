...
<form id="form-step-5" class="form-horizontal modalForm">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append">
                            ...
                            <input type="hidden" name="total-biaya-item-<?php echo $r->id ?>" id="total-item-<?php echo $r->id ?>"  value="<?php echo element('b-item-' . $r->id, $elektronik) ?>" />
                        </div>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <input type="hidden" id="total_biaya_elektronik_asli" name="total_biaya_elektronik_asli" value="<?php echo element('total_biaya_elektronik', $elektronik, 0) ?>" />
...
<div class="alert alert-info" style="text-align:right">
    ...
    <br> 
    <strong>Total Biaya Pemakaian Listrik:</strong> Rp. <span id="total_biaya_elektronik_text"><?php echo element('total_biaya_elektronik', $elektronik) ?></span>   &nbsp
