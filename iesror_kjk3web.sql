...
--
-- Host: localhost
-- Generation Time: Jul 28, 2012 at 02:14 PM
...
CREATE TABLE IF NOT EXISTS `auth_users` (
  ...
  `kota` varchar(64) collate utf8_unicode_ci NOT NULL,
  `jenis_kelamin` varchar(32) collate utf8_unicode_ci NOT NULL,
  `usia` varchar(64) collate utf8_unicode_ci NOT NULL,
  `pengeluaran` varchar(64) collate utf8_unicode_ci NOT NULL,
  `total_mobil` varchar(64) collate utf8_unicode_ci NOT NULL,
  `total_motor` varchar(64) collate utf8_unicode_ci NOT NULL,
  `jenis_lainnya` varchar(64) collate utf8_unicode_ci NOT NULL,
  `total_lainnya` varchar(64) collate utf8_unicode_ci NOT NULL,
  `jarak_tempuh` varchar(64) collate utf8_unicode_ci NOT NULL,
  `amdk` varchar(64) collate utf8_unicode_ci NOT NULL,
  `total_transit` varchar(63) collate utf8_unicode_ci NOT NULL,
  PRIMARY KEY  (`id`),
...
INSERT INTO `auth_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `fullname`, `propinsi_id`, `tipe_rumah`, `total_penghuni`, `pekerjaan`, `kota`, `jenis_kelamin`, `usia`, `pengeluaran`, `total_mobil`, `total_motor`, `jenis_lainnya`, `total_lainnya`, `jarak_tempuh`, `amdk`, `total_transit`) VALUES
(1, '\0\0', 'administrator', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1343016886, 1, 'Admin', 12, 'rumah', 0, '', '', '', '', '', '0', '0', '', '', '', '', ''),
(2, '\0\0', 'xa', 'bdb4d360f41da62ac9e7e858e5778b7291315499', NULL, 'test@test.com', NULL, NULL, NULL, NULL, 1336927466, 1336930204, 1, 'Tester #1', 17, 'rumah', 0, '', '', '', '', '', '0', '0', '', '', '', '', ''),
(3, '\0\0', 'Erwin Handoko', 'cc560b12bc929ba2fe6c6aff3ee19b96baa9be97', NULL, 'erwin@think.web.id', NULL, NULL, NULL, NULL, 1338957994, 1338958006, 1, 'Erwin Handoko', 12, 'rumah', 0, '', '', '', '', '', '0', '0', '', '', '', '', ''),
(4, '\0\0', 'Erwin Handoko1', '6d92a868f14d66c536fef8c6ae0dda2740500546', NULL, 'bhasunjaya@gmail.com', NULL, NULL, NULL, NULL, 1340902282, 1342097041, 1, 'Erwin Handoko', 12, 'rumah', 2, '', '', '', '', '', '0', '0', '', '', '', '', ''),
(5, '\0\0', 'asdasdasdasd', 'f8d0f699cb887ffde7381e31fa1018504b889fb7', NULL, 'bh@gmail.com', NULL, NULL, NULL, NULL, 1342968542, 1342968542, 1, 'asdasdasdasd', 12, 'rumah', 2, 'Wiraswasta', 'asdasd', 'Laki-laki', '< 18 thn', '5 Juta s/d 10 juta', '1', '1', 'sepeda', '1', '32', '3 s/d 5 botol', ''),
(6, '\0\0', 'asdasdasdasd1', '365544c20197b28bea775fd3d02dcfaea1b72772', NULL, '22bh@gmail.com', NULL, NULL, NULL, NULL, 1342968562, 1342968562, 1, 'asdasdasdasd', 12, 'rumah', 2, 'Wiraswasta', 'asdasd', 'Laki-laki', '< 18 thn', '5 Juta s/d 10 juta', '1', '1', 'sepeda', '1', '32', '3 s/d 5 botol', ''),
(7, '¶\n`æ', 'Sugeng Wibowo', '8b64a10a6aeba48506b40fa9ca50f921d4dea462', NULL, 'idsugeng@gmail.com', NULL, NULL, NULL, 'c39be7ae7c6701f0fd08fce049be629cef024b9b', 1343073754, 1343225786, 1, 'Sugeng Wibowo', 12, 'rumah', 2, 'NGO/LSM', 'Jakarta Selatan', 'Laki-laki', '25 - 35 thn', '> 10 juta', '', '1', '', '', '11', 'tidak mengkonsumsi', '1'),
(8, 'o^Œ¼', 'sugeng', 'e283ee168ea0dfa2caa0ffc47cc5f5ed7b8aa184', NULL, 'sugeng@satudunia.net', NULL, NULL, NULL, NULL, 1343179208, 1343183203, 1, 'sugeng', 12, 'rumah', 2, 'NGO/LSM', 'Jakarta Selatan', 'Laki-laki', '25 - 35 thn', '> 10 juta', '12', '12', 'dokar', '8', '10', '1 s/d 2 botol', '90');

-- --------------------------------------------------------

--
-- Table structure for table `auth_usersd`
--

CREATE TABLE IF NOT EXISTS `auth_usersd` (
  `id` mediumint(8) unsigned NOT NULL auto_increment,
  `ip_address` varbinary(16) NOT NULL,
  `username` varchar(100) collate utf8_unicode_ci NOT NULL,
  `password` varchar(40) collate utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `auth_usersd`
--

INSERT INTO `auth_usersd` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `fullname`, `propinsi_id`, `tipe_rumah`, `total_penghuni`, `pekerjaan`) VALUES
(1, '\0\0', 'administrator', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1342239307, 1, 'Admin', 12, 'rumah', 0, ''),
...
(5, 'Ê™„2', 'Deni Permana', '3815f89facad77f5a81dd338e7af124f475c2396', NULL, 'deni@duniakreatif.com', NULL, NULL, NULL, 'da05c9d3e32b9a905c99e619f0667db1f37970f7', 1342205230, 1342684752, 1, 'Deni Permana', 12, 'rumah', 2, ''),
(6, '´ý’', 'Sugeng Wibowo', '0fa06fc06983d1d7e3bc0dc25ac3c107cfdced3f', NULL, 'idsugeng@gmail.com', NULL, NULL, NULL, NULL, 1342386959, 1342491817, 1, 'Sugeng Wibowo', 12, 'rumah', 2, '');
...
(5, 'Airbus A319', 2310, 0.06, 0.1, 730, 69300, 124),
(6, 'Airbus A320', 2440, 0.06, 0.1, 770, 69300, 150);
...
(3, 'Bensin 1500cc', 'pribadi', 12, 3, 83, 3, 5, 0.0689),
(4, 'Bensin &gt; 2000cc', 'pribadi', 12, 3, 83, 3, 6, 0.0823),
(5, 'Diesel &lt; 1200cc', 'pribadi', 15, 9, 7, 3, 4, 0.00386),
(6, 'Diesel 1500cc', 'pribadi', 15, 9, 7, 3, 5, 0.0479),
...
--
-- Table structure for table `master_vehiclesccc`
--

CREATE TABLE IF NOT EXISTS `master_vehiclesccc` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `vehicle_name` varchar(32) collate utf8_unicode_ci NOT NULL,
  `vehicle_type` enum('pribadi','umum') collate utf8_unicode_ci NOT NULL,
  `n2o_cold` float NOT NULL,
...
--
-- Dumping data for table `master_vehiclesccc`
--

INSERT INTO `master_vehiclesccc` (`id`, `vehicle_name`, `vehicle_type`, `n2o_cold`, `n2o_hot`, `ch4_cold`, `ch4_hot`, `vehicle_capacity`, `fuel_economy`) VALUES
(1, 'Motor', 'pribadi', 2, 2, 200, 200, 1, 0.0769231),
(2, 'Bensin &lt; 1200cc', 'pribadi', 12, 3, 83, 3, 4, 0.0561),
